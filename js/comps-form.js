    ...
    $("#comps-form").submit(function (e) {
      ...
      if ($('#comps-form').valid()) {
        ...
        //   let Study_Area__c = '';
          ...
          let Email = $.trim($("input[name='form-email']").val().toLowerCase());
          ...
          let Study_Area__c = $("input[name='form-ia']:checked").map(function() {return this.value;}).get().join('; ');
          let Campus__c = $("input[name='form-location']:checked").map(function() {return this.value;}).get().join('; ');
            console.log('Campus__c: ', Study_Area__c);

          // let Campus__c = $("input[name='form-location']:checked").val();
          ...
          marketoSubmit(firstName, Email, mobilePhone, Lead_Type__c, Year_Level__c, Level_of_Study__c, Study_Area__c, Campus__c);
      } else {
         console.log("An error has occured");
      }

      function marketoSubmit(firstName, Email, mobilePhone, Lead_Type__c, Year_Level__c, Level_of_Study__c, Study_Area__c, Campus__c) {
